# Custom ESG Embedding Model for Vertical Search
...
2. `planning/p2-validation-findings.md` — Validation analysis: why this project was chosen over the Fine-Tune vs. Prompt alternative
